<?php
/**
 * Template Name: Fitness Together Template
 *
 * This template is a variant "child" template. Based on "index", it is SOLELY for use by the "fit" Portal. It does NOT
...
<head>
    ...
    <?php echo '<link media="all" type="text/css" href="'. get_template_directory_uri() .'/style-fit-portal01.css" rel="stylesheet">'; ?>
...
<?php if ( substr(strrchr(home_url($wp->request),"/"),1,strlen( strrchr( home_url($wp->request),"/" ) ) ) == 'fitness-together') : ?>
    <div class="fit-header"></div>

<?php endif; ?>

<?php if( substr(strrchr(home_url($wp->request),"/"),1,strlen( strrchr( home_url($wp->request),"/" ) ) ) == 'fitness-together') : ?>
    <nav class="site-navigation"></nav><!-- .site-navigation -->
    <div class="container fit-slides">
        <div class="carousel slide" id="myCarousel"><!-- BEGIN Slideshow Carousel -->
            <div class="carousel-inner">
                <div class="item active">
                    <img alt="" src="<?php echo get_template_directory_uri();?>/presentations/fit/fit_tp1_grfx_slide04.jpg">
                </div>
                <div class="item">
                    <img alt="" src="<?php echo get_template_directory_uri();?>/presentations/fit/fit_tp1_grfx_slide02.jpg">
                </div>
                <div class="item">
                    <img alt="" src="<?php echo get_template_directory_uri();?>/presentations/fit/fit_tp1_grfx_slide03.jpg">
                </div>
                <div class="item">
                    <img alt="" src="<?php echo get_template_directory_uri();?>/presentations/fit/fit_tp1_grfx_slide01.jpg">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="sidebar col-12 col-sm-5 col-lg-4">
                <a href="<?php echo site_url(); ?>/diesel-barber-shop">
                    <?php echo '<img src="'. get_template_directory_uri() .'/presentations/fit/fit_tp1_grfx_logo.png" >' ;?>
                </a>
                <div class="sidebar-navmenu">
                    <div class="sidebar-navmenu-button">
                        <b>Menu</b> <img src="<?php echo get_template_directory_uri();?>/presentations/fit/fit_tp1_grfx_home_menu_btn.png" style="cursor: pointer; display: inline-block;" id="sidebar-navmenu-btn">
                    </div>
    ...
    <div class="fit-footer">
        <div class="container">
            <div class="site-footer-inner col-12">
                ...
                <div class="site-info">
                    <div class="fit-footer-box col-12 col-sm-6 col-lg-5">
                        <?php echo '<img src="'. get_template_directory_uri() .'/presentations/fit/fit_tp1_grfx_logo_foot.png" >' ;?><br />
                    ...
                    <div class="fit-footer-box col-12 col-sm-6 col-lg-7" style="text-align:right;">
                        <br /><br />
