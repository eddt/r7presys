    ...
    <div class="container sam-header">
        ...
        <div class="row">
            ...
            <?php if ( substr(strrchr(home_url($wp->request),"/"),1,strlen( strrchr( home_url($wp->request),"/" ) ) ) == 'sam') : ?>
                ...
                <div class="portal-nav xcol-6 xcol-lg-6">
                    <div class="head-menu-button">
            ...
            <div class="sidebar col-12 col-sm-4 col-lg-4">
                    ...
                    <div class="sidebar-navmenu">
                        <div class="sidebar-navmenu-button">
                            <img src="<?php echo get_template_directory_uri();?>/presentations/sam/sam_tp1_grfx_hdr_btn.png" style="cursor: pointer; display: inline-block;" id="sidebar-navmenu-btn">
                        </div>
                        ...
                        <script>
                            jQuery("#sidebar-navmenu-btn").click(function() {
