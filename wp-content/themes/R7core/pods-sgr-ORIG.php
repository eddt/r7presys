...
<header id="masthead" class="site-header" role="banner">
    ...
    <div class="container sgr-header">
        ...
        <div class="row">
            ...
            <?php if ( substr(strrchr(home_url($wp->request),"/"),1,strlen( strrchr( home_url($wp->request),"/" ) ) ) == 'sgr') : ?>

                <div class="site-branding col-6 col-lg-4">
                    <a href="<?php echo site_url(); ?>/sgr">
                ...
                <div class="portal-nav col-6 col-lg-8">
                    <div class="head-menu-button" style="display:inline;">
                        ...
                        <?php wp_nav_menu( array('menu' => 'sgr',
                            'container'       => 'div',
