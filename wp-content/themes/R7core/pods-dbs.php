<?php
/**
 * Template Name: DBS Template
 *
 * This template is a variant "child" template. Based on "index", it is SOLELY for use by the "dbs" Portal. It does NOT
...
<?php if ( substr(strrchr(home_url($wp->request),"/"),1,strlen( strrchr( home_url($wp->request),"/" ) ) ) == 'dbs') : ?>
