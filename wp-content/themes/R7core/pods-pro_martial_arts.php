<?php
/**
 * Template Name: PRO Martial Arts Template
 *
 * This template is a variant "child" template. Based on "index", it is SOLELY for use by the "pro_martial_arts" Portal.
 * It does NOT use the R7 Core Header and Footer, using instead its own embedded versions, and the "Loop" has been
 * disabled and removed from the page as the content is called directly. Additionally the wp_sidebar() and wp_footer()
 * calls are commented out to strip down the page.
 *
 * Other changes:
